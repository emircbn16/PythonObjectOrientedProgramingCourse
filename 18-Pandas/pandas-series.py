...
opel2023 = pd.Series([20,30,40,10],["astra","corsa","mokka","insignia"])
opel2024 = pd.Series([20,30,40,10],["astra","corsa","Grandland","insignia"])

total = opel2023 + opel2024
print(total["astra"])